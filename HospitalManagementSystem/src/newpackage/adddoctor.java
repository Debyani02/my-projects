...
public class adddoctor implements ActionListener
{
    ...
    adddoctor(){
       ...
       ButtonGroup gender=new ButtonGroup();
        ...
        l6.setBounds(500,460,150,30);
        l6.setFont(font);
        
        l7=new JLabel("Department ID");
        l7.setBounds(500,510,150,30);
        l7.setFont(font);
        
        l8=new JLabel("Create Password");
        l8.setBounds(500,560,150,30);
        l8.setFont(font);
        ...
        t5=new JTextField();
        t5.setBounds(650,510,150,25);
        
        t6=new JTextField();
        t6.setBounds(650,560,150,25);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==b2){
            ...
            String sql="insert into doctors (name,age,gender,phone_no,specialization,department_id,password) values(?,?,?,?,?,?,?)";
