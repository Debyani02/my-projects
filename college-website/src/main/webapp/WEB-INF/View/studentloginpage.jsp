        ...
        <div class="conatiner ">
            <div class="row">
                <div class="form-space ">
                    ...
                    <div class="dp" ><img src="image/student-profile.png" height="100px"></div>
                    <div class="form-area">
                        <form method="post" action="student_validate">
                            <label>Username</label>
                            <input class="form-control" type="text" name="username" placeholder="Registration/University Roll No.">
